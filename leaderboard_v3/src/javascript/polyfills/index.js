...
try {
  if (!Element.prototype.addEventListener) {
    var eventListeners = [], addEventListener = function (e, t) {
      var n, r = this;
      if (n = function (e) {
...
"undefined" != typeof XDomainRequest && ("object" != typeof window.JSON && (window.JSON = {}), function () {
  "use strict";
...
try {
  ...
  Array.prototype.slice = function (t, e) {
    ...
    var r, i, c = [], l = this.length, o = t || 0;
    o = o >= 0 ? o : l + o;
    var a = e ? e : l;
    if (0 > e && (a = l + e), i = a - o, i > 0) if (c = new Array(i), this.charAt) for (r = 0; i > r; r++) c[r] = this.charAt(o + r); else for (r = 0; i > r; r++) c[r] = this[o + r];
    return c
  }
}
...
(function (global) {
  ...
  var EventSource = function (url) {
    var eventsource = this, interval = 500, /* polling interval  */ lastEventId = null, cache = '';
  ...
  EventSource.prototype = {
    close: function () { /* closes the connection - disabling the polling*/
      ...
      this._xhr.abort();
    }, CONNECTING: 0, OPEN: 1, CLOSED: 2, dispatchEvent: function (type, event) {
    ...
    }, onerror: null, onmessage: null, onopen: null, readyState: 0, URL: ''
  };
