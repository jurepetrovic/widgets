...
var _hasClass = _interopRequireDefault(require("../utils/hasClass"));

var _removeClass = _interopRequireDefault(require("../utils/removeClass"));

var _objectIterator = _interopRequireDefault(require("../utils/objectIterator"));

var _query = _interopRequireDefault(require("../utils/query"));

var _closest = _interopRequireDefault(require("../utils/closest"));

var _addClass = _interopRequireDefault(require("../utils/addClass"));

var _remove = _interopRequireDefault(require("../utils/remove"));

var _appendNext = _interopRequireDefault(require("../utils/appendNext"));

var _stripHtml = _interopRequireDefault(require("../utils/stripHtml"));
...
var MainWidget = function MainWidget(options) {
  ...
  this.accordionNavigation = function (element) {
    ...
    if ((0, _hasClass["default"])(parentEl, 'cl-shown')) {
      (0, _removeClass["default"])(parentEl, 'cl-shown');
    } else {
      (0, _objectIterator["default"])((0, _query["default"])((0, _closest["default"])(parentEl, '.cl-main-accordion-container'), '.cl-shown'), function (obj) {
        (0, _removeClass["default"])(obj, 'cl-shown');
      });
      (0, _addClass["default"])(parentEl, 'cl-shown');
    }
  };
  ...
  this.leaderboardHeader = function () {
    ...
    (0, _addClass["default"])(_this.settings.leaderboard.header, 'cl-reward-enabled');
  ...
  this.leaderboardRow = function (rank, icon, name, change, growth, points, reward, count, memberFound) {
    ...
    (0, _addClass["default"])(cellWrapper, 'cl-reward-enabled');
  ...
  this.leaderboardRowUpdate = function (rank, icon, name, change, growth, points, reward, count, memberFound, onMissing) {
    ...
    var cellRow = (0, _query["default"])(_this.settings.leaderboard.container, '.cl-lb-rank-' + rank + '.cl-lb-count-' + count);

    if (cellRow === null) {
      onMissing(rank, icon, name, change, growth, points, reward, count, memberFound);
    } else {
      var rankCel = (0, _query["default"])(cellRow, '.cl-rank-col-value');
      var iconCel = (0, _query["default"])(cellRow, '.cl-icon-col-img');
      var nameCel = (0, _query["default"])(cellRow, '.cl-name-col');
      var growthCel = (0, _query["default"])(cellRow, '.cl-growth-col');
      var pointsCel = (0, _query["default"])(cellRow, '.cl-points-col');
      var memberFoundClass = 'cl-lb-member-row';
      var rowHasClass = (0, _hasClass["default"])(cellRow, memberFoundClass);

      if (count > 0 && !(0, _hasClass["default"])(cellRow, 'cl-shared-rank')) {
        (0, _addClass["default"])(cellRow, 'cl-shared-rank');
      }

      if (memberFound && !rowHasClass) {
        (0, _addClass["default"])(cellRow, memberFoundClass);
      } else if (!memberFound && rowHasClass) {
        (0, _removeClass["default"])(cellRow, memberFoundClass);
      }
      ...
      if (typeof _this.settings.lbWidget.settings.competition.activeContest !== 'undefined' && _this.settings.lbWidget.settings.competition.activeContest !== null && typeof _this.settings.lbWidget.settings.competition.activeContest.rewards !== 'undefined' && _this.settings.lbWidget.settings.competition.activeContest.rewards.length > 0) {
        var rewardCel = (0, _query["default"])(cellRow, '.cl-reward-col');
  ...
  this.updateLeaderboardTopResults = function (topResults) {
    ...
    window.mapObject(topResults, function (lb) {
      ...
      (0, _objectIterator["default"])((0, _query["default"])(_this.settings.leaderboard.topResults, '.cl-lb-rank-' + lb.rank + '.cl-shared-rank'), function (obj) {
        (0, _remove["default"])(obj);
      });
    });
    (0, _objectIterator["default"])((0, _query["default"])(_this.settings.leaderboard.topResults, '.cl-lb-row'), function (obj) {
    ...
    window.mapObject(topResults, function (lb) {
      ...
      count, memberFound, function (rank, icon, name, change, growth, points, reward, count, memberFound) {
        ...
        var prevCellRow = (0, _query["default"])(_this.settings.leaderboard.container, '.cl-lb-rank-' + rank + '.cl-lb-count-' + (count - 1));

        if (prevCellRow !== null && typeof prevCellRow.length === 'undefined') {
          (0, _appendNext["default"])(prevCellRow, newRow);
        } else {
  ...
  this.updateLeaderboardResults = function (remainingResults) {
    ...
    window.mapObject(remainingResults, function (lb) {
      cleanupRankCheck.push(lb.rank);
      (0, _objectIterator["default"])((0, _query["default"])(_this.settings.leaderboard.list, '.cl-lb-rank-' + lb.rank + '.cl-shared-rank'), function (obj) {
        (0, _remove["default"])(obj);
      });
    });
    (0, _objectIterator["default"])((0, _query["default"])(_this.settings.leaderboard.container, '.cl-lb-row'), function (obj) {
      try {
        var rank = parseInt(obj.dataset.rank);
  ...
  this.updateLeaderboard = function () {
    ...
    var member = (0, _query["default"])(_this.settings.leaderboard.list, '.cl-lb-member-row');
  ...
  this.updateLeaderboardTime = function () {
    ...
    var diff = (0, _moment["default"])(_this.settings.lbWidget.settings.competition.activeContest.scheduledStart).diff((0, _moment["default"])());

    var date = _this.settings.lbWidget.formatDateTime(_moment["default"].duration(diff));
    ...
    if (diff < 0 && _this.settings.lbWidget.settings.competition.activeContest.statusCode === 0) {
      ...
      diff = (0, _moment["default"])(_this.settings.lbWidget.settings.competition.activeContest.scheduledEnd).diff((0, _moment["default"])());
      date = _this.settings.lbWidget.formatDateTime(_moment["default"].duration(diff));
  ...
  this.leaderboardDetailsUpdate = function () {
    ...
    var mainLabel = (0, _query["default"])(_this.settings.section, '.cl-main-widget-lb-details-content-label');
  ...
  this.leaderboardOptInCheck = function () {
    ...
    var optIn = (0, _query["default"])(_this.settings.section, '.cl-main-widget-lb-optin-action');
  ...
  this.preloader = function () {
    ...
    var preLoader = (0, _query["default"])(_this.settings.section, '.cl-main-widget-pre-loader'); // var content = query(_this.settings.section, '.cl-main-widget-pre-loader-content');
  ...
  this.loadLeaderboard = function (callback) {
    ...
    if (_this.settings.container === null) {
      ...
      _this.settings.navigation = (0, _query["default"])(_this.settings.container, '.cl-main-widget-navigation-container');
      _this.settings.section = (0, _query["default"])(_this.settings.container, '.cl-main-widget-section-container');
      _this.settings.leaderboard.container = (0, _query["default"])(_this.settings.section, '.cl-main-widget-lb-leaderboard');
      _this.settings.leaderboard.header = (0, _query["default"])(_this.settings.leaderboard.container, '.cl-main-widget-lb-leaderboard-header-labels');
      _this.settings.leaderboard.list = (0, _query["default"])(_this.settings.leaderboard.container, '.cl-main-widget-lb-leaderboard-body-res');
      _this.settings.leaderboard.topResults = (0, _query["default"])(_this.settings.leaderboard.container, '.cl-main-widget-lb-leaderboard-header-top-res');
      _this.settings.detailsContainer = (0, _query["default"])(_this.settings.container, '.cl-main-widget-lb-details-container');
      _this.settings.tournamentListContainer = (0, _query["default"])(_this.settings.container, '.cl-main-widget-tournaments-list');
      _this.settings.detailsContainerDate = (0, _query["default"])(_this.settings.container, '.cl-main-widget-lb-details-header-date');
      _this.settings.headerDate = (0, _query["default"])(_this.settings.container, '.cl-main-widget-lb-header-date');
      _this.settings.achievement.container = (0, _query["default"])(_this.settings.container, '.cl-main-widget-section-ach');
      _this.settings.achievement.detailsContainer = (0, _query["default"])(_this.settings.container, '.cl-main-widget-ach-details-container');
      _this.settings.reward.container = (0, _query["default"])(_this.settings.container, '.cl-main-widget-section-reward');
      _this.settings.reward.detailsContainer = (0, _query["default"])(_this.settings.container, '.cl-main-widget-reward-details-container');
      _this.settings.messages.container = (0, _query["default"])(_this.settings.container, '.cl-main-widget-section-inbox');
      _this.settings.messages.detailsContainer = (0, _query["default"])(_this.settings.container, '.cl-main-widget-inbox-details-container');
  ...
  this.hide = function (callback) {
    ...
    if (_this.settings.container !== null) {
      (0, _removeClass["default"])(_this.settings.container, 'cl-show');
      setTimeout(function () {
  ...
  this.missingMember = function (isVisible) {
    ...
    var area = (0, _query["default"])(_this.settings.container, '.cl-main-widget-lb-missing-member');
  ...
  this.competitionDetailsOptInButtonState = function () {
    ...
    var optIn = (0, _query["default"])(_this.settings.detailsContainer, '.cl-main-widget-lb-details-optin-action');
  ...
  this.loadCompetitionDetails = function (callback) {
    ...
    var label = (0, _query["default"])(_this.settings.detailsContainer, '.cl-main-widget-lb-details-header-label'); // var date = query(_this.settings.detailsContainer, '.cl-main-widget-lb-details-header-date');

    var body = (0, _query["default"])(_this.settings.detailsContainer, '.cl-main-widget-lb-details-body');
    var image = (0, _query["default"])(_this.settings.detailsContainer, '.cl-main-widget-lb-details-body-image-cont');
    image.innerHTML = '';
    ...
    if (_this.settings.lbWidget.settings.competition.extractImageHeader) {
      (0, _objectIterator["default"])((0, _query["default"])(body, 'img'), function (img, key, count) {
        if (count === 0) {
          var newImg = img.cloneNode(true);
          image.appendChild(newImg);
          (0, _remove["default"])(img);
        }
      });
    }

    setTimeout(function () {
      (0, _addClass["default"])(_this.settings.detailsContainer, 'cl-show');
  ...
  this.loadCompetitionList = function (callback, ajaxInstance) {
    ...
    var listResContainer = (0, _query["default"])(_this.settings.tournamentListContainer, '.cl-main-widget-tournaments-list-body-res');
    ...
    preLoader.show(function () {
      _this.settings.lbWidget.checkForAvailableCompetitions(function () {
        var accordionObj = _this.accordionStyle(_this.settings.tournamentsSection.accordionLayout, function (accordionSection, listContainer, topEntryContainer, layout) {
          ...
          if (typeof tournamentData !== 'undefined') {
            ...
            window.mapObject(tournamentData, function (tournament, key, count) {
              if (count + 1 <= layout.showTopResults && (0, _query["default"])(topEntryContainer, '.cl-tournament-' + tournament.id) === null) {
                var topEntryContaineRlistItem = _this.tournamentItem(tournament);

                topEntryContainer.appendChild(topEntryContaineRlistItem);
              }

              if ((0, _query["default"])(listContainer, '.cl-tournament-' + tournament.id) === null) {
        ...
        setTimeout(function () {
          (0, _addClass["default"])(_this.settings.tournamentListContainer, 'cl-show');
          if (typeof callback === 'function') callback();
          preLoader.hide();
        }, 50);
      }, ajaxInstance);
  ...
  this.hideCompetitionList = function (callback) {
    ...
    (0, _removeClass["default"])(_this.settings.tournamentListContainer, 'cl-show');
    setTimeout(function () {
  ...
  this.hideCompetitionDetails = function (callback) {
    ...
    (0, _removeClass["default"])(_this.settings.detailsContainer, 'cl-show');
    setTimeout(function () {
  ...
  this.achievementItem = function (ach, achieved, perc) {
    ...
    progressionBox.appendChild(progressionPercent); // wrapper has box, counter and button
  ...
  this.achievementListLayout = function (achievementData) {
    ...
    var achList = (0, _query["default"])(_this.settings.section, '.cl-main-widget-section-ach .cl-main-widget-ach-list-body-res');
    window.mapObject(achievementData, function (ach) {
      if ((0, _query["default"])(achList, '.cl-ach-' + ach.id) === null) {
  ...
  this.loadAchievementDetails = function (data, callback) {
    ...
    var label = (0, _query["default"])(_this.settings.achievement.detailsContainer, '.cl-main-widget-ach-details-header-label');
    var body = (0, _query["default"])(_this.settings.achievement.detailsContainer, '.cl-main-widget-ach-details-body');
    var image = (0, _query["default"])(_this.settings.achievement.detailsContainer, '.cl-main-widget-ach-details-body-image-cont');
    image.innerHTML = '';
    ...
    if (_this.settings.lbWidget.settings.achievements.extractImageHeader) {
      var imageLookup = (0, _query["default"])(body, 'img');
      (0, _objectIterator["default"])(imageLookup, function (img, key, count) {
        if (count === 0) {
          var newImg = img.cloneNode(true);
          image.appendChild(newImg);
          (0, _remove["default"])(img);
    ...
    setTimeout(function () {
      (0, _addClass["default"])(_this.settings.achievement.detailsContainer, 'cl-show');
      if (typeof callback === 'function') callback();
    }, 50);
  };
  ...
  this.hideAchievementDetails = function (callback) {
    ...
    (0, _removeClass["default"])(_this.settings.achievement.detailsContainer, 'cl-show');
    setTimeout(function () {
  ...
  this.loadRewardDetails = function (data, callback) {
    ...
    var label = (0, _query["default"])(_this.settings.reward.detailsContainer, '.cl-main-widget-reward-details-header-label');
    var body = (0, _query["default"])(_this.settings.reward.detailsContainer, '.cl-main-widget-reward-details-body');
    var image = (0, _query["default"])(_this.settings.reward.detailsContainer, '.cl-main-widget-reward-details-body-image-cont');
    var claimBtn = (0, _query["default"])(_this.settings.reward.detailsContainer, '.cl-main-widget-reward-claim-btn');
    var icon = (0, _query["default"])(_this.settings.reward.detailsContainer, '.cl-main-widget-reward-winnings-icon');
    var value = (0, _query["default"])(_this.settings.reward.detailsContainer, '.cl-main-widget-reward-winnings-value');
    ...
    if (data.data.claimed) {
      (0, _addClass["default"])(claimBtn, 'cl-claimed');
      claimBtn.innerHTML = _this.settings.lbWidget.settings.translation.rewards.claimed;
    } else {
      (0, _removeClass["default"])(claimBtn, 'cl-claimed');
    ...
    setTimeout(function () {
      (0, _addClass["default"])(_this.settings.reward.detailsContainer, 'cl-show');
      if (typeof callback === 'function') callback();
    }, 50);
  };
  ...
  this.loadMessageDetails = function (data, callback) {
    ...
    var label = (0, _query["default"])(_this.settings.messages.detailsContainer, '.cl-main-widget-inbox-details-header-label');
    var body = (0, _query["default"])(_this.settings.messages.detailsContainer, '.cl-main-widget-inbox-details-body');
    ...
    setTimeout(function () {
      (0, _addClass["default"])(_this.settings.messages.detailsContainer, 'cl-show');
      if (typeof callback === 'function') callback();
    }, 50);
  };
  ...
  this.hideRewardDetails = function (callback) {
    ...
    (0, _removeClass["default"])(_this.settings.reward.detailsContainer, 'cl-show');
    setTimeout(function () {
  ...
  this.hideMessageDetails = function (callback) {
    ...
    (0, _removeClass["default"])(_this.settings.messages.detailsContainer, 'cl-show');
    setTimeout(function () {
  ...
  this.getAchievementInfo = function (id) {
    ...
    try {
      for (var _iterator = _this.settings.lbWidget.settings.achievements.list[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var ach = _step.value;
  ...
  this.updateAchievementProgressionAndIssued = function (issued, progression) {
    ...
    var achList = (0, _query["default"])(_this.settings.section, '.cl-main-widget-section-ach .cl-main-widget-ach-list-body-res'); // iterate over displayed items

    (0, _objectIterator["default"])((0, _query["default"])(achList, '.cl-ach-list-item'), function (ach) {
      ...
      var issuedBox = (0, _query["default"])(ach, '.cl-ach-list-issued-box');
      ...
      window.mapObject(progression, function (pr) {
        if (pr.achievementId === id) {
          var count = (0, _query["default"])(issuedBox, '.cl-ach-list-issued-box-count');
          ...
          var checkBox = (0, _query["default"])(issuedBox, '.cl-ach-list-issued-box-check, .cl-ach-list-issued-box-not-check, .cl-ach-list-issued-box-gift');
      ...
      if (ach !== null) {
        var bar = (0, _query["default"])(ach, '.cl-ach-list-progression-bar');
        var percentNum = (0, _query["default"])(ach, '.cl-ach-list-percent-number');
        var rewardName = (0, _query["default"])(ach, '.cl-ach-list-details-reward');
  ...
  this.rewardItem = function (rew) {
    ...
    var labelText = (0, _stripHtml["default"])(rew.subject);
    var descriptionText = (0, _stripHtml["default"])(rew.body);

    if (typeof rew.prize !== 'undefined') {
      listItem.dataset.rewardId = rew.prize.id;
      labelText = (0, _stripHtml["default"])(rew.subject + ' - ' + rew.prize.reward.rewardName + ' (' + _this.settings.lbWidget.settings.rewards.rewardFormatter(rew.prize.reward) + ')');
      descriptionText = (0, _stripHtml["default"])(typeof rew.prize.reward.description !== 'undefined' && rew.prize.reward.description.length > 0 ? rew.prize.reward.description : rew.body);
    }
  ...
  this.messageItem = function (inbox) {
    ...
    var label = document.createElement('div');
    var description = document.createElement('div');
    var content = (0, _stripHtml["default"])(inbox.body);
  ...
  this.tournamentItem = function (tournament) {
    ...
    var label = document.createElement('div');
    var description = document.createElement('div');
    var descriptionContent = (0, _stripHtml["default"])(tournament.description);
  ...
  this.rewardsListLayout = function (rewards, availableRewards, expiredRewards) {
    ...
    var rewardList = (0, _query["default"])(_this.settings.section, '.cl-main-widget-section-reward .cl-main-widget-reward-list-body-res');
    ...
    var accordionObj = _this.accordionStyle(_this.settings.rewardsSection.accordionLayout, function (accordionSection, listContainer, topEntryContainer, layout) {
      ...
      if (typeof rewardData !== 'undefined') {
        ...
        window.mapObject(rewardData, function (rew, key, count) {
          if (count + 1 <= layout.showTopResults && (0, _query["default"])(topEntryContainer, '.cl-reward-' + rew.id) === null) {
            var topEntryContaineRlistItem = _this.rewardItem(rew);

            topEntryContainer.appendChild(topEntryContaineRlistItem);
          }

          if ((0, _query["default"])(listContainer, '.cl-reward-' + rew.id) === null) {
  ...
  this.messagesListLayout = function (rewards, availableRewards, expiredRewards) {
    ...
    var messageList = (0, _query["default"])(_this.settings.section, '.cl-main-widget-section-inbox .cl-main-widget-inbox-list-body-res');
  ...
  this.navigationSwitch = function (target, callback) {
    ...
    if (!_this.settings.navigationSwitchInProgress) {
      ...
      if (!(0, _hasClass["default"])(target.parentNode, 'cl-active-nav')) {
        preLoader.show(function () {
          if (changeInterval) clearTimeout(changeInterval);
          if (changeContainerInterval) clearTimeout(changeContainerInterval);
          (0, _objectIterator["default"])((0, _query["default"])(_this.settings.container, '.cl-main-widget-navigation-items .cl-active-nav'), function (obj) {
            (0, _removeClass["default"])(obj, 'cl-active-nav');
          });
          (0, _objectIterator["default"])((0, _query["default"])(_this.settings.container, '.cl-main-widget-section-container .cl-main-active-section'), function (obj) {
            (0, _removeClass["default"])(obj, 'cl-main-active-section');
            setTimeout(function () {
              obj.style.display = 'none';
            }, 150);
          });
          changeContainerInterval = setTimeout(function () {
            if ((0, _hasClass["default"])(target, 'cl-main-widget-navigation-lb-icon')) {
              _this.loadLeaderboard(function () {
                var lbContainer = (0, _query["default"])(_this.settings.container, '.cl-main-widget-section-container .cl-main-widget-lb');
                lbContainer.style.display = 'block';
                changeInterval = setTimeout(function () {
                  (0, _addClass["default"])(lbContainer, 'cl-main-active-section');
                }, 30);
            ...
            } else if ((0, _hasClass["default"])(target, 'cl-main-widget-navigation-ach-icon')) {
              _this.loadAchievements(function () {
                var achContainer = (0, _query["default"])(_this.settings.container, '.cl-main-widget-section-container .cl-main-widget-section-ach');
                _this.settings.achievement.detailsContainer.style.display = 'none';
                achContainer.style.display = 'block';
                changeInterval = setTimeout(function () {
                  (0, _addClass["default"])(achContainer, 'cl-main-active-section');
            ...
            } else if ((0, _hasClass["default"])(target, 'cl-main-widget-navigation-rewards-icon')) {
              _this.loadRewards(function () {
                var rewardsContainer = (0, _query["default"])(_this.settings.container, '.cl-main-widget-section-container .cl-main-widget-section-reward');
                rewardsContainer.style.display = 'block';
                changeInterval = setTimeout(function () {
                  (0, _addClass["default"])(rewardsContainer, 'cl-main-active-section');
                }, 30);
            ...
            } else if ((0, _hasClass["default"])(target, 'cl-main-widget-navigation-inbox-icon')) {
              _this.loadMessages(function () {
                var inboxContainer = (0, _query["default"])(_this.settings.container, '.cl-main-widget-section-container .cl-main-widget-section-inbox');
                inboxContainer.style.display = 'block';
                changeInterval = setTimeout(function () {
                  (0, _addClass["default"])(inboxContainer, 'cl-main-active-section');
                }, 30);
                preLoader.hide();
                _this.settings.navigationSwitchInProgress = false;
              });
          ...
          (0, _addClass["default"])(target.parentNode, 'cl-active-nav');
        });
      } else if (typeof callback === 'function') {
        _this.settings.navigationSwitchInProgress = false;
        callback();
  ...
  this.resetNavigation = function (callback) {
    ...
    (0, _addClass["default"])((0, _query["default"])(_this.settings.container, '.cl-main-widget-navigation-items .cl-main-widget-navigation-lb'), 'cl-active-nav');
    setTimeout(function () {
      lbContainer.style.display = 'block';
      setTimeout(function () {
        (0, _addClass["default"])(lbContainer, 'cl-main-active-section');
  ...
  this.initLayout = function (callback) {
    ...
    setTimeout(function () {
      (0, _addClass["default"])(_this.settings.container, 'cl-show');
      var member = (0, _query["default"])(_this.settings.leaderboard.list, '.cl-lb-member-row');
